...
"""
    ...
    Purpose: This API implements various 2D shapes
...
class Rectangle(Shape):
    ...
    Description:
        Method to calculate and return the perimeter of
        the Rectangle whose length and width exists in 
        the given instance.
...
class Triangle(Shape):
    ...
    Description:
        Constructor for Triangle that takes the three
